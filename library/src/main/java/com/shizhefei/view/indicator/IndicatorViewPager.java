...
public class IndicatorViewPager {
  ...
  public static abstract class IndicatorViewPagerAdapter extends LoopAdapter {
    ...
    @Override int getRealPosition(int position) {
      if (getCount() == 0) {
        return 0;
      }
    ...
    @Override void setLoop(boolean loop) {
      this.loop = loop;
    ...
    private RecyclingPagerAdapter pagerAdapter = new RecyclingPagerAdapter() {
      ...
      @Override public View getView(int position, View convertView, ViewGroup container) {
        return IndicatorViewPagerAdapter.this.getViewForPage(getRealPosition(position), convertView,
            container);
      }
    ...
    @Override public IndicatorAdapter getIndicatorAdapter() {
