...
public class OnTransitionTextListener implements OnTransitionListener {
     ...
     * @return
     */
    public LinearLayout getLinearLayout(View tabItemView, int position) {
        return (LinearLayout) tabItemView;
    }

    public TextView getTextView(View tabItemView, int position) {
        return (TextView) getLinearLayout(tabItemView, position).getChildAt(1);
    }
