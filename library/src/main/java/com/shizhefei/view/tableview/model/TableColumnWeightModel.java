package com.shizhefei.view.tableview.model;

import com.shizhefei.view.tableview.TableView;
import java.util.HashMap;
import java.util.Map;

/**
 * A model holding the column information of a {@link TableView}.
 * Such column information is the relative column width (alias ColumnWeight) and the number of
 * columns
 * (alias ColumnCount).
 *
 * @author ISchwarz
...
public class TableColumnWeightModel implements TableColumnModel {
  ...
  @Override public void setColumnCount(final int columnCount) {
    this.columnCount = columnCount;
  }

  @Override public int getColumnWidth(int columnIndex, int tableWidthInPx) {
