package com.shizhefei.view.tableview.toolkit;
...
public final class TableDataRowBackgroundProviders {
  ...
  /**
   * Gives an implementation of {@link TableDataRowBackgroundProvider} that will return alternately
   * the two
   * given colors.
   *
   ...
   */
  public static TableDataRowBackgroundProvider<Object> alternatingRowColors(final int colorEvenRows,
      final int colorOddRows) {
   ...
   * given colors.
   *
   * @param drawableEvenRows The {@link Drawable} that will be returned for rows with an even
   * index.
   * @param drawableOddRows The {@link Drawable}  that will be returned for rows with an odd index.
   * @return A {@link TableDataRowBackgroundProvider} with the described behaviour.
   */
  public static TableDataRowBackgroundProvider<Object> alternatingRowDrawables(
      final Drawable drawableEvenRows, final Drawable drawableOddRows) {
    return new AlternatingTableDataRowDrawableProvider(drawableEvenRows, drawableOddRows);
  }

  /**
   * Gives an implementation of {@link TableDataRowBackgroundProvider} that will return the given
   * color for each row.
   *
  ...
  /**
   * An implementation of {@link TableDataRowBackgroundProvider} that will return a {@link
   * ColorDrawable} for the
   * given color for every row.
   *
   * @author ISchwarz
   */
  private static class SimpleTableDataRowColorProvider
      implements TableDataRowBackgroundProvider<Object> {
    ...
    @Override public Drawable getRowBackground(final int rowIndex, final Object rowData) {
   ...
   * @author ISchwarz
   */
  private static class SimpleTableDataRowDrawableProvider
      implements TableDataRowBackgroundProvider<Object> {
  ...
  /**
   * An implementation of {@link TableDataRowBackgroundProvider} that will return alternately the
   * two
   * given colors as {@link ColorDrawable}.
   *
   * @author ISchwarz
   */
  private static class AlternatingTableDataRowColorProvider
      implements TableDataRowBackgroundProvider<Object> {
   ...
   * @author ISchwarz
   */
  private static class AlternatingTableDataRowDrawableProvider
      implements TableDataRowBackgroundProvider<Object> {

    private final Drawable drawableEven;
    private final Drawable drawableOdd;

    public AlternatingTableDataRowDrawableProvider(final Drawable drawableEven,
        final Drawable drawableOdd) {
