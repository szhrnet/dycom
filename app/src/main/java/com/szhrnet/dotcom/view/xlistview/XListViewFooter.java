...
public class XListViewFooter extends LinearLayout {
  ...
  private void initView(Context context) {
    ...
    LinearLayout moreView =
        (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.xlistview_footer, null);
    addView(moreView);
...
//    mHintView.setTextColor(ThemeHelper.getPrimaryColor());
  }

  public void setLoadMoreProgressBarColor(int color) {
