...
public class ArrayUtils {
  ...
  public static String join(String[] arrays, String separator) {
    return arrays == null ? "" : TextUtils.join(separator, arrays);
  }

  /**
   * 数组 根据 "," 生成 字符串
   */
  public static String joinDouHao(String[] arrays) {
    return join(arrays, ",");
  }
   ...
   * 数组 根据 "|" 生成 字符串
   */
  public static String joinLine(String[] arrays) {
    return join(arrays, "|");
  }
  ...
  public static String[] split(String string, String separator) {
    String[] split = TextUtils.split(string, separator);
    return split;
  }
   ...
   * 字符串 根据 "," 生成 数组
   */
  public static String[] splitDouHao(String string) {
    return split(string, ",");
  }
   ...
   * 字符串 根据 ";" 生成 数组
   */
  public static String[] splitFenHao(String string) {
    return split(string, ";");
  }
}
